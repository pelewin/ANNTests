...
public abstract class GameWorld {
	...
	protected final void buildAndSetGameLoop() {
		...
		final KeyFrame oneFrame = new KeyFrame(oneFrameAmt, this::handle); // oneFrame

		Timeline t = new Timeline(oneFrame);
	 ...
	 *
	 */
	protected void handleUpdate(Integer integer, List<Sprite> sprites) {
	}
	...
	protected void checkCollisions() {
		...
		for (Sprite spriteA : spriteManager.getCollisionsToCheck()) {
			for (Map.Entry<Integer, List<Sprite>> entries : spriteManager.getAllSprites().entrySet()) {
				for (Sprite spriteB : entries.getValue()) {
